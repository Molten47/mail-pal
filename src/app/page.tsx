  ...
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-10 max-w-md w-full text-center">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">mail-pal</h1>
        <p className="text-gray-500 dark:text-gray-400 mb-8">Your inbox, prioritized automatically.</p>
        <button
